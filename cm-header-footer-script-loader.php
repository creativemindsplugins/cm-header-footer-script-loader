...
if ( !class_exists( 'CMHeaderAndFooterSL' ) ) {
	...
	class CMHeaderAndFooterSL {
		...
		public static $plugin_name = 'CM Header & Footer Script Loader Free Version';
		public static $plugin_user_guide = 'https://www.cminds.com/wordpress-plugins-library/wordpress-header-and-footer-script-loader-plugin/';
		...
		public function __construct() {
			...
			if ( is_admin() ) {
				...
				$CMHeaderAndFooterSLBackend = CMHeaderAndFooterSLBackend::instance();
			...
			// Include frontend class otherwise, but only if license key is fine
				...
				$CMHeaderAndFooterSLFrontend = CMHeaderAndFooterSLFrontend::instance();
...
register_activation_hook( __FILE__, array( 'CMHeaderAndFooterSL', 'activate' ));
register_deactivation_hook( __FILE__, array( 'CMHeaderAndFooterSL', 'deactivate' ));

add_action( 'plugins_loaded', array( 'CMHeaderAndFooterSL', 'instance' ));